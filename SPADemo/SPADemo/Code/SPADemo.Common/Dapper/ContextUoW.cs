...
namespace SPADemo.Common.Dapper
{
    ...
    /// </summary>
    public class ContextUoW : IDisposable
    {
        private IDbTransaction _transaction;
        private readonly Action<ContextUoW> _onCommit;
        private readonly Action<ContextUoW> _onRollback;

        /// <summary>
        /// Creates a new <see cref="ContextUoW"/> instance.
        /// </summary>
        ...
        public ContextUoW(IDbTransaction transaction, Action<ContextUoW> onCommitOrRollback)
        ...
        public ContextUoW(IDbTransaction transaction, Action<ContextUoW> onCommit, Action<ContextUoW> onRollback)
        {
