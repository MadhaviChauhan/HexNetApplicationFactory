...
//module initialization for order module, this should also include all the modules injection which would be requiring in further operations
...
var apporder = angular.module('app.order', ['ngRoute','ui.bootstrap','ui.grid','ui.grid.selection','ui.grid.edit','ui.grid.pagination','ui.grid.resizeColumns']);
